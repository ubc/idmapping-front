...
//    'app/components/**/*.js',    // path to all JS files auto gen'd by editor
//    'app/components/**/*.js.map', // path to all sourcemap files auto gen'd by editor
//  ];
//
//  // delete the files
...
gulp.task('deploy-gh-pages', function() {
  return gulp.src(dist('**/*'))
    ...
    .pipe($.if(process.env.TRAVIS === 'true', $.ghPages({
      remoteUrl: 'https://$GH_TOKEN@github.com/ubc/idmap-front.git',
      silent: true,
      branch: 'gh-pages'
    }), $.ghPages()));
});
